            ...
            <div className="glass rounded-3xl p-8">
              <form className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select className="h-12 rounded-xl border border-white/10 bg-white/5 px-4 text-base text-white focus:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/30">
                    {designs.map((design) => (
                      <option
                        key={design.name}
                        value={design.name}
